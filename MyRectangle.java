...
public class MyRectangle implements Comparable <MyRectangle> {
	...
	public int compareTo(MyRectangle o) {
		...
		int surfaceObj= o.getHeight()*o.getWidth();
		int surfaceThis= this.height*this.width;
		
		if(surfaceThis>surfaceObj)
		{
			return 1;
		}
		else if(surfaceThis<surfaceObj)
		{
			return -1;
		}
		return 0;
	 ...
	 * @param form
	 */
	public  void drawShapee(Graphics	form) {
